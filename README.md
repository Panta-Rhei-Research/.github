...
Organization profile and shared community-health defaults for the **Panta Rhei Research Program**.
...
Publications are the stable artifact and release layer:
...
| Repository | Role |
|---|---|
| [`site`](https://github.com/Panta-Rhei-Research/site) | Jekyll source for `panta-rhei.site`, the public research observatory. |
| [`taulib`](https://github.com/Panta-Rhei-Research/taulib) | Lean 4 formalization surface; current metrics and trusted-base details live in the [Release Manifest](https://panta-rhei.site/verify/release-manifest/). |
| [`publications`](https://github.com/Panta-Rhei-Research/publications) | Source and release artifacts for monographs, papers, notes, briefings, white papers, ledgers, release artifacts, and errata. |
| [`research`](https://github.com/Panta-Rhei-Research/research) | Public workspace for notebooks, scripts, import reports, data transforms, experiments, and exploratory supporting material. |
...
- `profile/README.md`: the organization profile displayed on [github.com/Panta-Rhei-Research](https://github.com/Panta-Rhei-Research).
- Shared community-health files for code of conduct, support, security, issue templates, and pull request templates.
- Public routing defaults for Issues and Pull Requests across organization repositories.
